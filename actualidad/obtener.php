...
$stmt = mysqli_prepare($mysqli, "SELECT * FROM actualidad WHERE actualidad_id = ?");
                ...
                <div class="col-md-12">
                    <div class="title-center">
                        <div class="title-middle">
                            <h2 class="page-tagline">Situación actual <?php echo $row["categoria"]?></h2>
                            <h1 class="page-title"><?php echo $row["titulo"]?></h1>
                            <h5 class="page-tagline">Por <?php echo $row["autor"]?></h5>
                        </div>
                    </div>
                </div>
            </div>
